...
//----------------------------------------------------------------------
//
// Method: _PatchGITRevision - Patch GIT revision in a source file
//

Status Build::_PatchGITRevision(String const &fileName) { // Build._PatchGITRevision...

  Status  status;

/* Needs changing from SVN to GIT...
