...
#===============================================================================
#
# File: errors.py - Various Exceptions
#
# Note: The class 'Error' conflicts with funcs.py:Error() so, if you really need
#       these exceptions AND you import BOTH, your choice on how to avoid the
